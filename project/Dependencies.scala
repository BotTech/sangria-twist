...
trait Dependencies {
  ...
  object Npm {
    ...
    object Versions {
      ...
      val apollo = "2.27.4"
      val apolloBoost = "0.4.8"
      val apolloClient = "2.6.9"
      val autoprefixer = "9.7.6"
      val bootstrap = "4.5.0"
      val cssLoader = "3.5.3"
      val colorguard = "1.2.1"
      val doiuse = "4.2.0"
      val fileLoader = "6.0.0"
      val graphQL = "15.0.0"
      val graphQLTag = "2.10.3"
      val jquery = "3.5.1"
      val miniCSSExtractPlugin = "0.9.0"
      val nodeSass = "4.14.1"
      val optimizeCSSAssetsWebpackPlugin = "5.0.3"
      val postCSSLoader = "3.0.0"
      val postCSSSorting = "5.0.1"
      val react = "16.13.1"
      val reactApollo = "3.1.5"
      val reactProxy = "1.1.8"
      val sassLoader = "8.0.2"
      val stylelint = "13.3.3"
      val stylelintConfigStandard = "20.0.0"
      val uglifyJSWebpackPlugin = "2.2.0"
      val webpackMerge = "4.2.2"
    }
